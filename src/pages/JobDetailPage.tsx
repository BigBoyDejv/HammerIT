...
export function JobDetailPage() {
    ...
    const canSubmitOffer = profile?.role === 'craftsman' && !isMyJob && job.status === 'open';
        ...
        <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
                <div className="flex items-start justify-between mb-4">
                    ...
                    <span className={`text-xs font-medium px-2.5 py-1 rounded-full ml-4 shrink-0 ${job.status === 'open'
                                    ...
                                    <div className="flex justify-between items-start gap-4">
                                        <div className="flex-1">
                                            ...
                                            <p className="text-sm text-gray-500 mt-0.5">
                                                Odhad: {offer.estimated_duration ?? '–'}
                                            </p>
                                            ...
                                            {offer.status === 'pending' && (
                                                <>
                                                    ...
                                                    <button
                                                        ...
                                                        disabled={actionLoading === offer.id}
                                                        className="text-xs py-1.5 px-3 border border-red-300 text-red-600 rounded-lg hover:bg-red-50 transition-colors"
                                                    >
                                                        Zamietnuť
                                                    </button>
                                                </>
            ...
            {canSubmitOffer && (
                <div className="bg-white rounded-xl shadow-md p-6">
                    <h2 className="text-2xl font-bold text-gray-900 mb-1">Odoslať ponuku</h2>

                    {alreadyOffered && (
                        <p className="text-sm text-yellow-700 bg-yellow-50 border border-yellow-200 px-3 py-2 rounded-lg mt-3">
                            Už ste odoslali ponuku na túto prácu.
                        </p>
                    )}
