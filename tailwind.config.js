// tailwind.config.js - kompletný súbor
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-mesh': 'radial-gradient(at 40% 20%, rgba(255, 77, 26, 0.1) 0px, transparent 50%), radial-gradient(at 80% 0%, rgba(25, 25, 112, 0.08) 0px, transparent 50%)',
      },
